...
from .zsddota import ZSDDotaDataset
from .dior import DIORDataset
from .zsddior import ZSDDIORDataset
from .xview import XViewDataset
from .zsdxview import ZSDXViewDataset

from .zsddior_unseen import ZSDDIORDataset_Unseen
from .zsddota_unseen import ZSDDotaDataset_Unseen
from .zsdxview_unseen import ZSDXViewDataset_Unseen

from .wdota import DotaDataset_W
from .wzsddota import ZSDDotaDataset_W
from .wzsddota_unseen import ZSDDotaDataset_Unseen_W
...
__all__ = [
    ...
    'CustomSampleSizeSampler', 'Flickr30kDataset', 'VisdroneDataset', 'MultiModalDataset',
    'DotaDataset', 'ZSDDotaDataset', 'DIORDataset', 'ZSDDIORDataset',
    'XViewDataset', 'ZSDXViewDataset',
    'ZSDDIORDataset_Unseen', 'ZSDDotaDataset_Unseen', 'ZSDXViewDataset_Unseen',
    'DotaDataset_W', 'ZSDDotaDataset_W', 'ZSDDotaDataset_Unseen_W',
    'UAVDTDataset'
]
