...
from .text_utils import to_2tuple
from .text_pos_embed import get_2d_sincos_pos_embed
...
class TextTransformer(nn.Module):
    ...
    def init_parameters(self):
        ...
        # print(f"Backbone_Text_model_Load finish")
    ...
    def forward(self, text):
        ...
        bz = len(text)
        cls_num = len(text[0])
        flat_texts = [item for sublist in text for item in sublist]
        text_tokens = tokenizer.tokenize(flat_texts)
        text = text_tokens.to('cuda')
