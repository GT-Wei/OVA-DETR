...
backend_args = None
load_from = './pretrain_model/mmdetr_datasets/epoch_30.pth'
work_dir = 'work_dirs/UAVDT/fine_tune'
...
# ----------------------------------------------uavdt
uavdt_dataset_type = 'UAVDTDataset'
uavdt_data_root = '/home/disk/datasets/UAVDT/'
uavdt_train_dataset = dict(
    type='MultiModalDataset',
    dataset=dict(
        type=uavdt_dataset_type,
        data_root=uavdt_data_root,
        ann_file='annotations/UAV-benchmark-M-Train.json',
        data_prefix=dict(img='train/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='class_text/texts/uavdt_class_texts.json',
    pipeline=train_pipeline)
uavdt_val_dataset = dict(
    type='MultiModalDataset',
    dataset=dict(
        type=uavdt_dataset_type,
        data_root=uavdt_data_root,
...
uavdt_val_evaluator = dict(
    type='CocoMetric',
    ann_file=uavdt_data_root + 'annotations/UAV-benchmark-M-Val.json',
    metric='bbox',
    format_only=False,
    classwise=True,
...
val_dataloader = dict(
    ...
    dataset=uavdt_val_dataset)
test_dataloader = val_dataloader


val_evaluator = uavdt_val_evaluator
