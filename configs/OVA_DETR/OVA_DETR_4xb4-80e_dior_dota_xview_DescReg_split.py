...
work_dir = 'work_dirs/Real_final_version/R50_DescReg_split'
...
# ----------------------------------------------dota
dota_dataset_type = 'DotaDataset_W'
dota_zero_shot_dataset_type = "ZSDDotaDataset_W"
dota_zero_shot_dataset_type_unseen = "ZSDDotaDataset_Unseen_W"
dota_data_root = '/home/disk/datasets/DOTA_wrong_split/DOTA_split/'
dota_train_dataset = dict(
    ...
    class_text_path='class_text/texts/W_dota_seen_class_texts.json',
...
dota_val_dataset = dict(
    ...
    dataset=dict(
        ...
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='class_text/texts/W_dota_test_class_texts.json',
...
dota_val_dataset_zsd = dict(
    ...
    class_text_path='class_text/texts/W_dota_test_class_texts_zsd.json',
    pipeline=test_pipeline)
